...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    media: [
      ...
      {
        src: '/portfolio/recipes-detail.png',
        alt: 'Vegetarian lasagne recipe detail and guided cooking entry point',
        width: 1440,
        height: 900,
        layout: 'half',
      },
      {
        src: '/portfolio/recipes-ideas.png',
        alt: 'Community recipe ideas submission and publishing workspace',
        width: 1440,
        height: 900,
        layout: 'half',
      },
  ...
  },
  {
    ...
    media: [
      {
        src: '/portfolio/cercle-home.png',
        alt: 'Cercle des Langues homepage and training proposition',
        width: 1440,
        height: 900,
      },
      {
        src: '/portfolio/cercle-formation.png',
        alt: 'Online English training programme landing page',
        width: 1440,
        height: 900,
        layout: 'half',
      },
      {
        src: '/portfolio/cercle-testimonials.png',
        alt: 'Cercle des Langues student testimonials experience',
        width: 1440,
        height: 900,
        layout: 'half',
      },
  ...
  },
  {
    ...
    media: [
      ...
      },
      {
        ...
        alt: 'Volvamed practitioner search and booking homepage',
        width: 1440,
        height: 900,
        layout: 'half',
      },
      {
        src: '/portfolio/volvamed-therapist.png',
        alt: 'Volvamed practice management product for wellbeing practitioners',
        width: 1440,
        height: 900,
        layout: 'half',
      },
